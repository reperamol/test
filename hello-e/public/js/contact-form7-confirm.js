...
jQuery(document).ready(function(){
		...
		pages : [
			{
				...
				'button' : {
					...
					'confirm' :
						'<input type="image" src="/wp-content/themes/mmss/img/other/btn_conf.png" alt="入力内容を確認する" class="button-confirm">',
					'rewrite' :
						'<input type="image" src="/wp-content/themes/mmss/img/other/btn_back.png" alt="戻る" class="button-rewrite">'+
						'<input type="image" src="/wp-content/themes/mmss/img/other/btn_send.png" alt="送信" class="wpcf7-form-control wpcf7-submit">'
				}
			}
		],
		validates : {
	...
	.each(function(){
		...
		jQuery(this).children('.error_area')
		.prepend(
		...
		.click(function(){
			...
			jQuery('html,body').animate({ scrollTop: form.children('.sub_title').offset().top - 10}, 'slow', null);
			return false;
		});
